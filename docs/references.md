...
| Resource | URL | Description |
|---|---|---|
| **Rapid-MLX** | [https://github.com/radames/Rapid-MLX](https://github.com/radames/Rapid-MLX) | Faster MLX inference engine with optimized kernels. |
| **oMLX** | [https://github.com/riccardoperini/omlx](https://github.com/riccardoperini/omlx) | Ollama-compatible server using MLX as the inference backend. Drop-in replacement for Ollama. |
| **mlx-omni-server** | [https://github.com/fg-i/mlx-omni-server](https://github.com/fg-i/mlx-omni-server) | Multi-model MLX server with OpenAI-compatible API, vision support, and tool calling. |
...
| **LLMCheck** | [https://llmcheck.com](https://llmcheck.com) | LLM performance database with Apple Silicon-specific benchmarks. |
...
| **mlx-omni-server** | [https://github.com/fg-i/mlx-omni-server](https://github.com/fg-i/mlx-omni-server) | Technical article on building a multi-model MLX server with vision and tool-calling support. |
